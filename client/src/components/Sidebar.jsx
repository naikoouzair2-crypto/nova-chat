...
const AVATAR_SEEDS = [
    'Felix', 'Aneka', 'Zack', 'Molly', 'Leo', 'Simba', 'Nala', 'Willow', 'Jack', 'Lola',
    'Oliver', 'Bella', 'Max', 'Lucy', 'Charlie', 'Rocky', 'Luna', 'Cooper', 'Daisy', 'Bear',
    'Sophie', 'Teddy', 'Chloe', 'Duke', 'Coco', 'Buster', 'Rosie', 'Riley', 'Ruby', 'Harley',
    'Lily', 'Zoe', 'Bailey', 'Stella', 'Penny', 'Milo', 'Jasper', 'Otis', 'Scout', 'Tucker',
    'Bentley', 'Marley', 'Ginger', 'Abby', 'Sasha', 'Princess', 'Peanut', 'Shadow', 'Hazel', 'Bruno'
];
